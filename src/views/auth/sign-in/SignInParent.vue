          ...
          <div class="box">
            <form @submit.prevent="signIn($event)" novalidate>
              <div class="field">
                ...
                <Username :placeholder="'부모님계정을 입력해주세요'" icons-left="fa-solid fa-user"
...
import { SignInNormal, ResetPassword } from "@/routers/auth.router"
...
export default defineComponent({
  ...
  setup() {
    const username = ref('')
    const password = ref('')
    const signInPath = SignInNormal.path
